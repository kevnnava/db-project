...
public class GettingColumnInformation {
    ...
    /*
    ResultSet object only stores Rwo data
    It does not store any column information
    like column names, column data types, column counts
    In order to get column information
    We need to get ResultSetMetaData object from ResultSet

    What is MetaData? It is data about data
    ResultSetMetaData holds information about tge ResultObject
    ...
    public static void main(String[] args) throws SQLException {
        ...
        // First we need to ResultSetMetaData object by calling the method below
        ResultSetMetaData rsmd = rs.getMetaData();
        // This ResultSetMetaData has 2 methods we care about
        // getColumnCount method to get the count of the column
        ...
        // WRITE A PIECE OF CODE THAT GOES THROUGH EACH AND EVERY CELL
