-- Display all FIRST_NAME that has letter a as the second character
-- '_a%'
SELECT FIRST_NAME
FROM EMPLOYEES
...
-- 2.4 Display ALL Departments with DEPARTMENT_NAME that Contains IT
-- exclude the exact match department name IT
SELECT * FROM DEPARTMENTS
WHERE DEPARTMENT_NAME LIKE '%IT %';

-- 3.4 Display the Employee Count for EACH FIRST_NAME (observe what you got)
...
------ SQL JOIN ------
-- IS USED TO GET DATA FROM 2 OR MORE TABLES THAT ARE RELATED TO EACH OTHER
-- PRIMARY KEY AND FOREIGN KEY RELATIONSHIP

-- INNER JOIN, LEFT OUTER JOIN, RIGHT OUTER JOIN, FULL OUTER JOIN

-- IN ORDER TO JOIN TWO TABLES THAT HAVE A RELATIONSHIP
...
-- INNER JOIN WILL RETURN THE DATA THAT MATCHES FROM BOTH TABLES
-- IT IS RETURNING ONLY ROWS THAT HAVE MATCHING DEPARTMENT_ID FROM BOTH TABLES
-- ANYTHING ELSE IS EXCLUDED
-- FOR EXAMPLE: KIMBERLY WITH NO DEPARTMENT ID
--              DEPARTMENT WITH NO EMPLOYEES (MEANING NONE OF THE EMPLOYEES HAVE THOSE DEPARTMENT_ID)
...
-- SUCH AS KIMBERLY HAS NULL DEPARTMENT ID BUT WE STILL WANT TO GET THAT DATA
-- 106 ROWS
SELECT e.FIRST_NAME, d.DEPARTMENT_NAME
FROM EMPLOYEES e
...
-- THIS IS THE NO ALIAS VERSION OF THE SAME QUERY (SAME THING AS CODE ABOVE)
SELECT EMPLOYEES.FIRST_NAME,
       JOBS.JOB_TITLE,
